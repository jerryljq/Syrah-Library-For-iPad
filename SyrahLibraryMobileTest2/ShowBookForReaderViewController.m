//
//  ShowBookForReaderViewController.m
...
#import "ShowBookForReaderViewController.h"

@interface ShowBookForReaderViewController ()
@property (weak, nonatomic) IBOutlet UINavigationBar *navBar;
@property (weak, nonatomic) IBOutlet UITableView *bookList;
@property (strong, nonatomic)NSMutableArray *dataArray;
@property (strong, nonatomic)SyrahBorrowCard *currentUser;

@end

@implementation ShowBookForReaderViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"UbookInfo"];
    // Configure the cell...
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSMutableArray *sendInfo = [[NSMutableArray alloc] init];
    [sendInfo addObject:[self.dataArray objectAtIndex:indexPath.row]];
    //[sendInfo addObject:_currentUser];
    
    [self performSegueWithIdentifier:@"userBookInfoView" sender:self];
    //Notification operation is block operations. MUST performSegue first.
    NSNotification *bookinfo = [NSNotification notificationWithName:@"borrowInfo" object:sendInfo];
